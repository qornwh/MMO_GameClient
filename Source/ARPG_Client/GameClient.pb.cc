...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_GameClient_2eproto = {
  false, false, 4666, descriptor_table_protodef_GameClient_2eproto, "GameClient.proto", 
